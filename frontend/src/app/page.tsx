...
export default function DashboardPage() {
  ...
  return (
    <div className={`flex min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] ${isDarkMode ? "dark-mode" : "light-mode"} transition-colors duration-300 relative overflow-hidden`}>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-72 max-h-screen overflow-y-auto custom-scrollbar bg-[var(--bg-sidebar)] border-r border-[var(--border-card)] p-5 flex flex-col justify-between shadow-2xl transition-transform duration-300 md:hidden ${
        ...
        <div className="pt-2.5 border-t border-[var(--border-card)] space-y-2 flex-shrink-0">
          ...
          >
            ...
            {sidebarCollapsed ? (
              ...
              <div
                className={`w-8 h-4.5 rounded-full p-0.5 transition-colors relative flex items-center border ${
                  isDarkMode ? "bg-slate-700 border-slate-600" : "bg-slate-200 border-slate-300"
                }`}
              >
                <div
                  className={`w-3.5 h-3.5 rounded-full shadow-sm transition-transform duration-200 ${
                    isDarkMode ? "bg-blue-500 translate-x-3.5" : "bg-slate-500 translate-x-0"
                  }`}
                />
              </div>
            )}
      ...
      >
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 w-full md:w-auto">
            ...
            <div className="relative w-full sm:w-auto" ref={dropdownRef}>
              <button
                ...
                className="w-full sm:w-auto bg-[var(--bg-input)] hover:bg-[var(--bg-card)] border border-[var(--border-input)] hover:border-cyan-500/50 text-[var(--text-primary)] px-3.5 py-2 rounded-full text-xs font-semibold flex items-center justify-between sm:justify-start gap-2.5 shadow-lg backdrop-blur-md transition-all active:scale-98 group cursor-pointer"
              >
              ...
              {deviceDropdownOpen && (
                <div className="absolute right-0 mt-2 w-full sm:w-80 md:w-96 bg-[#0B132B]/95 dark:bg-[#090D16]/95 backdrop-blur-2xl p-4 shadow-2xl z-50 border border-cyan-500/40 animate-in fade-in slide-in-from-top-2 duration-150 rounded-2xl text-[var(--text-primary)]">
            ...
            <button
              ...
              disabled={loading}
              className="w-full sm:w-auto justify-center bg-blue-600 hover:bg-blue-500 text-white font-semibold px-4 py-2.5 rounded-full text-xs flex items-center gap-2 shadow-lg shadow-blue-600/30 active:scale-95 transition-transform cursor-pointer"
            >
        ...
        {userModalOpen && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-50 flex items-center justify-center p-4">
            <div className="glass-card p-5 sm:p-6 w-full max-w-md max-h-[90vh] flex flex-col my-auto overflow-hidden border border-indigo-500/40 shadow-2xl relative animate-in zoom-in-95 duration-150">
              <div className="flex items-center justify-between mb-3 pb-3 border-b border-[var(--border-card)] flex-shrink-0">
                <div className="flex items-center gap-2">
              ...
              <form onSubmit={handleSaveUser} className="flex-1 overflow-y-auto space-y-3.5 pr-1 text-xs custom-scrollbar">
                <div>
                ...
                <div className="flex justify-end gap-2 pt-3 border-t border-[var(--border-card)] flex-shrink-0">
                  <button
                    type="button"
        ...
        {profileModalOpen && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-50 flex items-center justify-center p-4">
            <div className="glass-card p-5 sm:p-6 w-full max-w-lg max-h-[90vh] flex flex-col my-auto overflow-hidden border border-cyan-500/40 shadow-2xl relative animate-in zoom-in-95 duration-150">
              <div className="flex items-center justify-between mb-3 pb-3 border-b border-[var(--border-card)] flex-shrink-0">
                <div className="flex items-center gap-3">
                  <div className={`w-9 h-9 rounded-full ${profileForm.avatarColor} flex items-center justify-center text-white font-bold text-sm shadow-md`}>
              ...
              {profileSuccessMsg && (
                <div className="mb-3 p-3 rounded-xl bg-emerald-500/15 border border-emerald-500/30 text-emerald-400 text-xs font-semibold flex items-center gap-2 flex-shrink-0">
              ...
              {profileErrorMsg && (
                <div className="mb-3 p-3 rounded-xl bg-rose-500/15 border border-rose-500/30 text-rose-400 text-xs font-semibold flex items-center gap-2 flex-shrink-0">
                  <AlertTriangle className="w-4 h-4 flex-shrink-0 text-rose-400" />
                  <span>{profileErrorMsg}</span>
                </div>
              )}

              <form onSubmit={handleSaveProfile} className="flex-1 overflow-y-auto space-y-3.5 pr-1 text-xs custom-scrollbar">
                {/* Full Name */}
                <div>
        ...
        {editingNicknameDeviceId && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-50 flex items-center justify-center p-4">
            <div className="glass-card p-5 sm:p-6 w-full max-w-md max-h-[90vh] flex flex-col my-auto overflow-hidden border border-cyan-500/30 shadow-2xl relative animate-in zoom-in-95 duration-150">
              <div className="flex items-center justify-between mb-3 pb-3 border-b border-[var(--border-card)] flex-shrink-0">
                <div className="flex items-center gap-2">
